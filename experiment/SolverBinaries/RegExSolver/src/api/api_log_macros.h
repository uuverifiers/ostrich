...
void log_Z3_mk_str_count(Z3_context a0, Z3_ast a1, Z3_ast a2);
#define LOG_Z3_mk_str_count(_ARG0, _ARG1, _ARG2) z3_log_ctx _LOG_CTX; if (_LOG_CTX.enabled()) { log_Z3_mk_str_count(_ARG0, _ARG1, _ARG2); }
