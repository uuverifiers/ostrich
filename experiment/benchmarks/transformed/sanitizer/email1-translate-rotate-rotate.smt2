...
(assert (= Email (str.++ Domainname (str.++ Username "Z"))))
(assert (str.in.re Email (re.++ (re.union (re.range "a" "z") (re.+ (re.++ (re.++ (re.union (re.+ (str.to.re "<")) (re.union (re.range "0" "9") (re.+ (re.+ (re.union (re.range "0" "9") (re.union (re.range "a" "z") (re.range "A" "Z"))))))) (str.to.re "Z")) (re.++ (re.range "a" "z") (re.range "A" "Z"))))) (re.union (re.range "0" "9") (re.range "A" "Z")))))
