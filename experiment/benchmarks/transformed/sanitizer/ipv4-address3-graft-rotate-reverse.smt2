...
(assert (str.in.re IPAddr (re.++ (re.* (re.++ (re.++ (re.++ (str.to.re ".") (re.* (re.++ (re.++ (re.++ (str.to.re ".") (re.* (re.++ (re.++ (re.range "0" "9") (re.+ (re.++ (re.range "0" "2") (re.* (re.++ (re.+ (str.to.re ".")) (re.range "0" "9")))))) (re.range "0" "2")))) (re.++ (re.range "0" "9") (re.+ (re.+ (re.range "0" "9"))))) (re.range "0" "2")))) (re.++ (re.range "0" "9") (re.+ (re.+ (re.range "0" "9"))))) (re.range "0" "2"))) (re.++ (re.range "0" "9") (re.+ (re.+ (re.range "0" "9")))))))
