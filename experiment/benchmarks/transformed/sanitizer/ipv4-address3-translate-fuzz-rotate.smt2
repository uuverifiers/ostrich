...
(assert (str.in.re IPAddr (re.union (re.++ (re.+ (re.+ (re.range "0" "9"))) (re.range "0" "9")) (re.+ (re.++ (re.range "0" "2") (re.++ (re.union (re.* (re.+ (re.range "0" "9"))) (re.range "0" "9")) (re.++ (re.* (re.union (re.range "0" "2") (re.++ (re.++ (re.* (re.+ (re.range "0" "9"))) (re.range "0" "9")) (re.union (re.+ (re.union (re.range "0" "2") (re.++ (re.* (re.union (re.+ (re.* (re.range "0" "9"))) (re.range "0" "9"))) (re.++ (re.range "0" "2") (str.to.re "H"))))) (str.to.re "v"))))) (str.to.re ","))))))))
