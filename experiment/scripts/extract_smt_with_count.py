...
# parse arguments
parser = argparse.ArgumentParser(prog=__file__, description="Extract smt2 files with count.")
parser.add_argument("inputdir")
parser.add_argument("-outdir", default="../count_benchmark")
