...
void exec_Z3_solver_get_implied_value(z3_replayer & in) {
  Z3_ast result = Z3_solver_get_implied_value(
    reinterpret_cast<Z3_context>(in.get_obj(0)),
    reinterpret_cast<Z3_solver>(in.get_obj(1)),
    reinterpret_cast<Z3_ast>(in.get_obj(2)));
  in.store_result(result);
}
void exec_Z3_solver_get_implied_lower(z3_replayer & in) {
  Z3_ast result = Z3_solver_get_implied_lower(
    reinterpret_cast<Z3_context>(in.get_obj(0)),
    reinterpret_cast<Z3_solver>(in.get_obj(1)),
    reinterpret_cast<Z3_ast>(in.get_obj(2)));
  in.store_result(result);
}
void exec_Z3_solver_get_implied_upper(z3_replayer & in) {
  Z3_ast result = Z3_solver_get_implied_upper(
    reinterpret_cast<Z3_context>(in.get_obj(0)),
    reinterpret_cast<Z3_solver>(in.get_obj(1)),
    reinterpret_cast<Z3_ast>(in.get_obj(2)));
  in.store_result(result);
...
void register_z3_replayer_cmds(z3_replayer & in) {
  ...
  in.register_cmd(456, exec_Z3_solver_get_implied_value, "Z3_solver_get_implied_value");
  in.register_cmd(457, exec_Z3_solver_get_implied_lower, "Z3_solver_get_implied_lower");
  in.register_cmd(458, exec_Z3_solver_get_implied_upper, "Z3_solver_get_implied_upper");
