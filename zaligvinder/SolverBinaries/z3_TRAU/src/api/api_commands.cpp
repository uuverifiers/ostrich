...
void register_z3_replayer_cmds(z3_replayer & in) {
  ...
  in.register_cmd(281, exec_Z3_get_numeral_decimal_string, "Z3_get_numeral_decimal_string");
  in.register_cmd(282, exec_Z3_get_numeral_double, "Z3_get_numeral_double");
  in.register_cmd(283, exec_Z3_get_numerator, "Z3_get_numerator");
  in.register_cmd(284, exec_Z3_get_denominator, "Z3_get_denominator");
  in.register_cmd(285, exec_Z3_get_numeral_small, "Z3_get_numeral_small");
  in.register_cmd(286, exec_Z3_get_numeral_int, "Z3_get_numeral_int");
  in.register_cmd(287, exec_Z3_get_numeral_uint, "Z3_get_numeral_uint");
  in.register_cmd(288, exec_Z3_get_numeral_uint64, "Z3_get_numeral_uint64");
  in.register_cmd(289, exec_Z3_get_numeral_int64, "Z3_get_numeral_int64");
  in.register_cmd(290, exec_Z3_get_numeral_rational_int64, "Z3_get_numeral_rational_int64");
  in.register_cmd(291, exec_Z3_get_algebraic_number_lower, "Z3_get_algebraic_number_lower");
  in.register_cmd(292, exec_Z3_get_algebraic_number_upper, "Z3_get_algebraic_number_upper");
  in.register_cmd(293, exec_Z3_pattern_to_ast, "Z3_pattern_to_ast");
  in.register_cmd(294, exec_Z3_get_pattern_num_terms, "Z3_get_pattern_num_terms");
  in.register_cmd(295, exec_Z3_get_pattern, "Z3_get_pattern");
  in.register_cmd(296, exec_Z3_get_index_value, "Z3_get_index_value");
  in.register_cmd(297, exec_Z3_is_quantifier_forall, "Z3_is_quantifier_forall");
  in.register_cmd(298, exec_Z3_is_quantifier_exists, "Z3_is_quantifier_exists");
  in.register_cmd(299, exec_Z3_is_lambda, "Z3_is_lambda");
  in.register_cmd(300, exec_Z3_get_quantifier_weight, "Z3_get_quantifier_weight");
  in.register_cmd(301, exec_Z3_get_quantifier_num_patterns, "Z3_get_quantifier_num_patterns");
  in.register_cmd(302, exec_Z3_get_quantifier_pattern_ast, "Z3_get_quantifier_pattern_ast");
  in.register_cmd(303, exec_Z3_get_quantifier_num_no_patterns, "Z3_get_quantifier_num_no_patterns");
  in.register_cmd(304, exec_Z3_get_quantifier_no_pattern_ast, "Z3_get_quantifier_no_pattern_ast");
  in.register_cmd(305, exec_Z3_get_quantifier_num_bound, "Z3_get_quantifier_num_bound");
  in.register_cmd(306, exec_Z3_get_quantifier_bound_name, "Z3_get_quantifier_bound_name");
  in.register_cmd(307, exec_Z3_get_quantifier_bound_sort, "Z3_get_quantifier_bound_sort");
  in.register_cmd(308, exec_Z3_get_quantifier_body, "Z3_get_quantifier_body");
  in.register_cmd(309, exec_Z3_simplify, "Z3_simplify");
  in.register_cmd(310, exec_Z3_simplify_ex, "Z3_simplify_ex");
  in.register_cmd(311, exec_Z3_simplify_get_help, "Z3_simplify_get_help");
  in.register_cmd(312, exec_Z3_simplify_get_param_descrs, "Z3_simplify_get_param_descrs");
  in.register_cmd(313, exec_Z3_update_term, "Z3_update_term");
  in.register_cmd(314, exec_Z3_substitute, "Z3_substitute");
  in.register_cmd(315, exec_Z3_substitute_vars, "Z3_substitute_vars");
  in.register_cmd(316, exec_Z3_translate, "Z3_translate");
  in.register_cmd(317, exec_Z3_mk_model, "Z3_mk_model");
  in.register_cmd(318, exec_Z3_model_inc_ref, "Z3_model_inc_ref");
  in.register_cmd(319, exec_Z3_model_dec_ref, "Z3_model_dec_ref");
  in.register_cmd(320, exec_Z3_model_eval, "Z3_model_eval");
  in.register_cmd(321, exec_Z3_model_get_const_interp, "Z3_model_get_const_interp");
  in.register_cmd(322, exec_Z3_model_has_interp, "Z3_model_has_interp");
  in.register_cmd(323, exec_Z3_model_get_func_interp, "Z3_model_get_func_interp");
  in.register_cmd(324, exec_Z3_model_get_num_consts, "Z3_model_get_num_consts");
  in.register_cmd(325, exec_Z3_model_get_const_decl, "Z3_model_get_const_decl");
  in.register_cmd(326, exec_Z3_model_get_num_funcs, "Z3_model_get_num_funcs");
  in.register_cmd(327, exec_Z3_model_get_func_decl, "Z3_model_get_func_decl");
  in.register_cmd(328, exec_Z3_model_get_num_sorts, "Z3_model_get_num_sorts");
  in.register_cmd(329, exec_Z3_model_get_sort, "Z3_model_get_sort");
  in.register_cmd(330, exec_Z3_model_get_sort_universe, "Z3_model_get_sort_universe");
  in.register_cmd(331, exec_Z3_model_translate, "Z3_model_translate");
  in.register_cmd(332, exec_Z3_is_as_array, "Z3_is_as_array");
  in.register_cmd(333, exec_Z3_get_as_array_func_decl, "Z3_get_as_array_func_decl");
  in.register_cmd(334, exec_Z3_add_func_interp, "Z3_add_func_interp");
  in.register_cmd(335, exec_Z3_add_const_interp, "Z3_add_const_interp");
  in.register_cmd(336, exec_Z3_func_interp_inc_ref, "Z3_func_interp_inc_ref");
  in.register_cmd(337, exec_Z3_func_interp_dec_ref, "Z3_func_interp_dec_ref");
  in.register_cmd(338, exec_Z3_func_interp_get_num_entries, "Z3_func_interp_get_num_entries");
  in.register_cmd(339, exec_Z3_func_interp_get_entry, "Z3_func_interp_get_entry");
  in.register_cmd(340, exec_Z3_func_interp_get_else, "Z3_func_interp_get_else");
  in.register_cmd(341, exec_Z3_func_interp_set_else, "Z3_func_interp_set_else");
  in.register_cmd(342, exec_Z3_func_interp_get_arity, "Z3_func_interp_get_arity");
  in.register_cmd(343, exec_Z3_func_interp_add_entry, "Z3_func_interp_add_entry");
  in.register_cmd(344, exec_Z3_func_entry_inc_ref, "Z3_func_entry_inc_ref");
  in.register_cmd(345, exec_Z3_func_entry_dec_ref, "Z3_func_entry_dec_ref");
  in.register_cmd(346, exec_Z3_func_entry_get_value, "Z3_func_entry_get_value");
  in.register_cmd(347, exec_Z3_func_entry_get_num_args, "Z3_func_entry_get_num_args");
  in.register_cmd(348, exec_Z3_func_entry_get_arg, "Z3_func_entry_get_arg");
  in.register_cmd(349, exec_Z3_toggle_warning_messages, "Z3_toggle_warning_messages");
  in.register_cmd(350, exec_Z3_set_ast_print_mode, "Z3_set_ast_print_mode");
  in.register_cmd(351, exec_Z3_ast_to_string, "Z3_ast_to_string");
  in.register_cmd(352, exec_Z3_pattern_to_string, "Z3_pattern_to_string");
  in.register_cmd(353, exec_Z3_sort_to_string, "Z3_sort_to_string");
  in.register_cmd(354, exec_Z3_func_decl_to_string, "Z3_func_decl_to_string");
  in.register_cmd(355, exec_Z3_model_to_string, "Z3_model_to_string");
  in.register_cmd(356, exec_Z3_benchmark_to_smtlib_string, "Z3_benchmark_to_smtlib_string");
  in.register_cmd(357, exec_Z3_parse_smtlib2_string, "Z3_parse_smtlib2_string");
  in.register_cmd(358, exec_Z3_parse_smtlib2_file, "Z3_parse_smtlib2_file");
  in.register_cmd(359, exec_Z3_eval_smtlib2_string, "Z3_eval_smtlib2_string");
  in.register_cmd(360, exec_Z3_get_error_code, "Z3_get_error_code");
  in.register_cmd(361, exec_Z3_set_error, "Z3_set_error");
  in.register_cmd(362, exec_Z3_get_error_msg, "Z3_get_error_msg");
  in.register_cmd(363, exec_Z3_get_version, "Z3_get_version");
  in.register_cmd(364, exec_Z3_get_full_version, "Z3_get_full_version");
  in.register_cmd(365, exec_Z3_enable_trace, "Z3_enable_trace");
  in.register_cmd(366, exec_Z3_disable_trace, "Z3_disable_trace");
  in.register_cmd(367, exec_Z3_reset_memory, "Z3_reset_memory");
  in.register_cmd(368, exec_Z3_finalize_memory, "Z3_finalize_memory");
  in.register_cmd(369, exec_Z3_mk_goal, "Z3_mk_goal");
  in.register_cmd(370, exec_Z3_goal_inc_ref, "Z3_goal_inc_ref");
  in.register_cmd(371, exec_Z3_goal_dec_ref, "Z3_goal_dec_ref");
  in.register_cmd(372, exec_Z3_goal_precision, "Z3_goal_precision");
  in.register_cmd(373, exec_Z3_goal_assert, "Z3_goal_assert");
  in.register_cmd(374, exec_Z3_goal_inconsistent, "Z3_goal_inconsistent");
  in.register_cmd(375, exec_Z3_goal_depth, "Z3_goal_depth");
  in.register_cmd(376, exec_Z3_goal_reset, "Z3_goal_reset");
  in.register_cmd(377, exec_Z3_goal_size, "Z3_goal_size");
  in.register_cmd(378, exec_Z3_goal_formula, "Z3_goal_formula");
  in.register_cmd(379, exec_Z3_goal_num_exprs, "Z3_goal_num_exprs");
  in.register_cmd(380, exec_Z3_goal_is_decided_sat, "Z3_goal_is_decided_sat");
  in.register_cmd(381, exec_Z3_goal_is_decided_unsat, "Z3_goal_is_decided_unsat");
  in.register_cmd(382, exec_Z3_goal_translate, "Z3_goal_translate");
  in.register_cmd(383, exec_Z3_goal_convert_model, "Z3_goal_convert_model");
  in.register_cmd(384, exec_Z3_goal_to_string, "Z3_goal_to_string");
  in.register_cmd(385, exec_Z3_goal_to_dimacs_string, "Z3_goal_to_dimacs_string");
  in.register_cmd(386, exec_Z3_mk_tactic, "Z3_mk_tactic");
  in.register_cmd(387, exec_Z3_tactic_inc_ref, "Z3_tactic_inc_ref");
  in.register_cmd(388, exec_Z3_tactic_dec_ref, "Z3_tactic_dec_ref");
  in.register_cmd(389, exec_Z3_mk_probe, "Z3_mk_probe");
  in.register_cmd(390, exec_Z3_probe_inc_ref, "Z3_probe_inc_ref");
  in.register_cmd(391, exec_Z3_probe_dec_ref, "Z3_probe_dec_ref");
  in.register_cmd(392, exec_Z3_tactic_and_then, "Z3_tactic_and_then");
  in.register_cmd(393, exec_Z3_tactic_or_else, "Z3_tactic_or_else");
  in.register_cmd(394, exec_Z3_tactic_par_or, "Z3_tactic_par_or");
  in.register_cmd(395, exec_Z3_tactic_par_and_then, "Z3_tactic_par_and_then");
  in.register_cmd(396, exec_Z3_tactic_try_for, "Z3_tactic_try_for");
  in.register_cmd(397, exec_Z3_tactic_when, "Z3_tactic_when");
  in.register_cmd(398, exec_Z3_tactic_cond, "Z3_tactic_cond");
  in.register_cmd(399, exec_Z3_tactic_repeat, "Z3_tactic_repeat");
  in.register_cmd(400, exec_Z3_tactic_skip, "Z3_tactic_skip");
  in.register_cmd(401, exec_Z3_tactic_fail, "Z3_tactic_fail");
  in.register_cmd(402, exec_Z3_tactic_fail_if, "Z3_tactic_fail_if");
  in.register_cmd(403, exec_Z3_tactic_fail_if_not_decided, "Z3_tactic_fail_if_not_decided");
  in.register_cmd(404, exec_Z3_tactic_using_params, "Z3_tactic_using_params");
  in.register_cmd(405, exec_Z3_probe_const, "Z3_probe_const");
  in.register_cmd(406, exec_Z3_probe_lt, "Z3_probe_lt");
  in.register_cmd(407, exec_Z3_probe_gt, "Z3_probe_gt");
  in.register_cmd(408, exec_Z3_probe_le, "Z3_probe_le");
  in.register_cmd(409, exec_Z3_probe_ge, "Z3_probe_ge");
  in.register_cmd(410, exec_Z3_probe_eq, "Z3_probe_eq");
  in.register_cmd(411, exec_Z3_probe_and, "Z3_probe_and");
  in.register_cmd(412, exec_Z3_probe_or, "Z3_probe_or");
  in.register_cmd(413, exec_Z3_probe_not, "Z3_probe_not");
  in.register_cmd(414, exec_Z3_get_num_tactics, "Z3_get_num_tactics");
  in.register_cmd(415, exec_Z3_get_tactic_name, "Z3_get_tactic_name");
  in.register_cmd(416, exec_Z3_get_num_probes, "Z3_get_num_probes");
  in.register_cmd(417, exec_Z3_get_probe_name, "Z3_get_probe_name");
  in.register_cmd(418, exec_Z3_tactic_get_help, "Z3_tactic_get_help");
  in.register_cmd(419, exec_Z3_tactic_get_param_descrs, "Z3_tactic_get_param_descrs");
  in.register_cmd(420, exec_Z3_tactic_get_descr, "Z3_tactic_get_descr");
  in.register_cmd(421, exec_Z3_probe_get_descr, "Z3_probe_get_descr");
  in.register_cmd(422, exec_Z3_probe_apply, "Z3_probe_apply");
  in.register_cmd(423, exec_Z3_tactic_apply, "Z3_tactic_apply");
  in.register_cmd(424, exec_Z3_tactic_apply_ex, "Z3_tactic_apply_ex");
  in.register_cmd(425, exec_Z3_apply_result_inc_ref, "Z3_apply_result_inc_ref");
  in.register_cmd(426, exec_Z3_apply_result_dec_ref, "Z3_apply_result_dec_ref");
  in.register_cmd(427, exec_Z3_apply_result_to_string, "Z3_apply_result_to_string");
  in.register_cmd(428, exec_Z3_apply_result_get_num_subgoals, "Z3_apply_result_get_num_subgoals");
  in.register_cmd(429, exec_Z3_apply_result_get_subgoal, "Z3_apply_result_get_subgoal");
  in.register_cmd(430, exec_Z3_mk_solver, "Z3_mk_solver");
  in.register_cmd(431, exec_Z3_mk_simple_solver, "Z3_mk_simple_solver");
  in.register_cmd(432, exec_Z3_mk_solver_for_logic, "Z3_mk_solver_for_logic");
  in.register_cmd(433, exec_Z3_mk_solver_from_tactic, "Z3_mk_solver_from_tactic");
  in.register_cmd(434, exec_Z3_solver_translate, "Z3_solver_translate");
  in.register_cmd(435, exec_Z3_solver_import_model_converter, "Z3_solver_import_model_converter");
  in.register_cmd(436, exec_Z3_solver_get_help, "Z3_solver_get_help");
  in.register_cmd(437, exec_Z3_solver_get_param_descrs, "Z3_solver_get_param_descrs");
  in.register_cmd(438, exec_Z3_solver_set_params, "Z3_solver_set_params");
  in.register_cmd(439, exec_Z3_solver_inc_ref, "Z3_solver_inc_ref");
  in.register_cmd(440, exec_Z3_solver_dec_ref, "Z3_solver_dec_ref");
  in.register_cmd(441, exec_Z3_solver_interrupt, "Z3_solver_interrupt");
  in.register_cmd(442, exec_Z3_solver_push, "Z3_solver_push");
  in.register_cmd(443, exec_Z3_solver_pop, "Z3_solver_pop");
  in.register_cmd(444, exec_Z3_solver_reset, "Z3_solver_reset");
  in.register_cmd(445, exec_Z3_solver_get_num_scopes, "Z3_solver_get_num_scopes");
  in.register_cmd(446, exec_Z3_solver_assert, "Z3_solver_assert");
  in.register_cmd(447, exec_Z3_solver_assert_and_track, "Z3_solver_assert_and_track");
  in.register_cmd(448, exec_Z3_solver_from_file, "Z3_solver_from_file");
  in.register_cmd(449, exec_Z3_solver_from_string, "Z3_solver_from_string");
  in.register_cmd(450, exec_Z3_solver_get_assertions, "Z3_solver_get_assertions");
  in.register_cmd(451, exec_Z3_solver_get_units, "Z3_solver_get_units");
  in.register_cmd(452, exec_Z3_solver_get_trail, "Z3_solver_get_trail");
  in.register_cmd(453, exec_Z3_solver_get_non_units, "Z3_solver_get_non_units");
  in.register_cmd(454, exec_Z3_solver_get_levels, "Z3_solver_get_levels");
  in.register_cmd(455, exec_Z3_solver_check, "Z3_solver_check");
  in.register_cmd(456, exec_Z3_solver_check_assumptions, "Z3_solver_check_assumptions");
  in.register_cmd(457, exec_Z3_get_implied_equalities, "Z3_get_implied_equalities");
  in.register_cmd(458, exec_Z3_solver_get_consequences, "Z3_solver_get_consequences");
  in.register_cmd(459, exec_Z3_solver_cube, "Z3_solver_cube");
  in.register_cmd(460, exec_Z3_solver_get_model, "Z3_solver_get_model");
  in.register_cmd(461, exec_Z3_solver_get_proof, "Z3_solver_get_proof");
  in.register_cmd(462, exec_Z3_solver_get_unsat_core, "Z3_solver_get_unsat_core");
  in.register_cmd(463, exec_Z3_solver_get_reason_unknown, "Z3_solver_get_reason_unknown");
  in.register_cmd(464, exec_Z3_solver_get_statistics, "Z3_solver_get_statistics");
  in.register_cmd(465, exec_Z3_solver_to_string, "Z3_solver_to_string");
  in.register_cmd(466, exec_Z3_solver_to_dimacs_string, "Z3_solver_to_dimacs_string");
  in.register_cmd(467, exec_Z3_stats_to_string, "Z3_stats_to_string");
  in.register_cmd(468, exec_Z3_stats_inc_ref, "Z3_stats_inc_ref");
  in.register_cmd(469, exec_Z3_stats_dec_ref, "Z3_stats_dec_ref");
  in.register_cmd(470, exec_Z3_stats_size, "Z3_stats_size");
  in.register_cmd(471, exec_Z3_stats_get_key, "Z3_stats_get_key");
  in.register_cmd(472, exec_Z3_stats_is_uint, "Z3_stats_is_uint");
  in.register_cmd(473, exec_Z3_stats_is_double, "Z3_stats_is_double");
  in.register_cmd(474, exec_Z3_stats_get_uint_value, "Z3_stats_get_uint_value");
  in.register_cmd(475, exec_Z3_stats_get_double_value, "Z3_stats_get_double_value");
  in.register_cmd(476, exec_Z3_get_estimated_alloc_size, "Z3_get_estimated_alloc_size");
  in.register_cmd(477, exec_Z3_mk_ast_vector, "Z3_mk_ast_vector");
  in.register_cmd(478, exec_Z3_ast_vector_inc_ref, "Z3_ast_vector_inc_ref");
  in.register_cmd(479, exec_Z3_ast_vector_dec_ref, "Z3_ast_vector_dec_ref");
  in.register_cmd(480, exec_Z3_ast_vector_size, "Z3_ast_vector_size");
  in.register_cmd(481, exec_Z3_ast_vector_get, "Z3_ast_vector_get");
  in.register_cmd(482, exec_Z3_ast_vector_set, "Z3_ast_vector_set");
  in.register_cmd(483, exec_Z3_ast_vector_resize, "Z3_ast_vector_resize");
  in.register_cmd(484, exec_Z3_ast_vector_push, "Z3_ast_vector_push");
  in.register_cmd(485, exec_Z3_ast_vector_translate, "Z3_ast_vector_translate");
  in.register_cmd(486, exec_Z3_ast_vector_to_string, "Z3_ast_vector_to_string");
  in.register_cmd(487, exec_Z3_mk_ast_map, "Z3_mk_ast_map");
  in.register_cmd(488, exec_Z3_ast_map_inc_ref, "Z3_ast_map_inc_ref");
  in.register_cmd(489, exec_Z3_ast_map_dec_ref, "Z3_ast_map_dec_ref");
  in.register_cmd(490, exec_Z3_ast_map_contains, "Z3_ast_map_contains");
  in.register_cmd(491, exec_Z3_ast_map_find, "Z3_ast_map_find");
  in.register_cmd(492, exec_Z3_ast_map_insert, "Z3_ast_map_insert");
  in.register_cmd(493, exec_Z3_ast_map_erase, "Z3_ast_map_erase");
  in.register_cmd(494, exec_Z3_ast_map_reset, "Z3_ast_map_reset");
  in.register_cmd(495, exec_Z3_ast_map_size, "Z3_ast_map_size");
  in.register_cmd(496, exec_Z3_ast_map_keys, "Z3_ast_map_keys");
  in.register_cmd(497, exec_Z3_ast_map_to_string, "Z3_ast_map_to_string");
  in.register_cmd(498, exec_Z3_algebraic_is_value, "Z3_algebraic_is_value");
  in.register_cmd(499, exec_Z3_algebraic_is_pos, "Z3_algebraic_is_pos");
  in.register_cmd(500, exec_Z3_algebraic_is_neg, "Z3_algebraic_is_neg");
  in.register_cmd(501, exec_Z3_algebraic_is_zero, "Z3_algebraic_is_zero");
  in.register_cmd(502, exec_Z3_algebraic_sign, "Z3_algebraic_sign");
  in.register_cmd(503, exec_Z3_algebraic_add, "Z3_algebraic_add");
  in.register_cmd(504, exec_Z3_algebraic_sub, "Z3_algebraic_sub");
  in.register_cmd(505, exec_Z3_algebraic_mul, "Z3_algebraic_mul");
  in.register_cmd(506, exec_Z3_algebraic_div, "Z3_algebraic_div");
  in.register_cmd(507, exec_Z3_algebraic_root, "Z3_algebraic_root");
  in.register_cmd(508, exec_Z3_algebraic_power, "Z3_algebraic_power");
  in.register_cmd(509, exec_Z3_algebraic_lt, "Z3_algebraic_lt");
  in.register_cmd(510, exec_Z3_algebraic_gt, "Z3_algebraic_gt");
  in.register_cmd(511, exec_Z3_algebraic_le, "Z3_algebraic_le");
  in.register_cmd(512, exec_Z3_algebraic_ge, "Z3_algebraic_ge");
  in.register_cmd(513, exec_Z3_algebraic_eq, "Z3_algebraic_eq");
  in.register_cmd(514, exec_Z3_algebraic_neq, "Z3_algebraic_neq");
  in.register_cmd(515, exec_Z3_algebraic_roots, "Z3_algebraic_roots");
  in.register_cmd(516, exec_Z3_algebraic_eval, "Z3_algebraic_eval");
  in.register_cmd(517, exec_Z3_polynomial_subresultants, "Z3_polynomial_subresultants");
  in.register_cmd(518, exec_Z3_rcf_del, "Z3_rcf_del");
  in.register_cmd(519, exec_Z3_rcf_mk_rational, "Z3_rcf_mk_rational");
  in.register_cmd(520, exec_Z3_rcf_mk_small_int, "Z3_rcf_mk_small_int");
  in.register_cmd(521, exec_Z3_rcf_mk_pi, "Z3_rcf_mk_pi");
  in.register_cmd(522, exec_Z3_rcf_mk_e, "Z3_rcf_mk_e");
  in.register_cmd(523, exec_Z3_rcf_mk_infinitesimal, "Z3_rcf_mk_infinitesimal");
  in.register_cmd(524, exec_Z3_rcf_mk_roots, "Z3_rcf_mk_roots");
  in.register_cmd(525, exec_Z3_rcf_add, "Z3_rcf_add");
  in.register_cmd(526, exec_Z3_rcf_sub, "Z3_rcf_sub");
  in.register_cmd(527, exec_Z3_rcf_mul, "Z3_rcf_mul");
  in.register_cmd(528, exec_Z3_rcf_div, "Z3_rcf_div");
  in.register_cmd(529, exec_Z3_rcf_neg, "Z3_rcf_neg");
  in.register_cmd(530, exec_Z3_rcf_inv, "Z3_rcf_inv");
  in.register_cmd(531, exec_Z3_rcf_power, "Z3_rcf_power");
  in.register_cmd(532, exec_Z3_rcf_lt, "Z3_rcf_lt");
  in.register_cmd(533, exec_Z3_rcf_gt, "Z3_rcf_gt");
  in.register_cmd(534, exec_Z3_rcf_le, "Z3_rcf_le");
  in.register_cmd(535, exec_Z3_rcf_ge, "Z3_rcf_ge");
  in.register_cmd(536, exec_Z3_rcf_eq, "Z3_rcf_eq");
  in.register_cmd(537, exec_Z3_rcf_neq, "Z3_rcf_neq");
  in.register_cmd(538, exec_Z3_rcf_num_to_string, "Z3_rcf_num_to_string");
  in.register_cmd(539, exec_Z3_rcf_num_to_decimal_string, "Z3_rcf_num_to_decimal_string");
  in.register_cmd(540, exec_Z3_rcf_get_numerator_denominator, "Z3_rcf_get_numerator_denominator");
  in.register_cmd(541, exec_Z3_mk_fixedpoint, "Z3_mk_fixedpoint");
  in.register_cmd(542, exec_Z3_fixedpoint_inc_ref, "Z3_fixedpoint_inc_ref");
  in.register_cmd(543, exec_Z3_fixedpoint_dec_ref, "Z3_fixedpoint_dec_ref");
  in.register_cmd(544, exec_Z3_fixedpoint_add_rule, "Z3_fixedpoint_add_rule");
  in.register_cmd(545, exec_Z3_fixedpoint_add_fact, "Z3_fixedpoint_add_fact");
  in.register_cmd(546, exec_Z3_fixedpoint_assert, "Z3_fixedpoint_assert");
  in.register_cmd(547, exec_Z3_fixedpoint_query, "Z3_fixedpoint_query");
  in.register_cmd(548, exec_Z3_fixedpoint_query_relations, "Z3_fixedpoint_query_relations");
  in.register_cmd(549, exec_Z3_fixedpoint_get_answer, "Z3_fixedpoint_get_answer");
  in.register_cmd(550, exec_Z3_fixedpoint_get_reason_unknown, "Z3_fixedpoint_get_reason_unknown");
  in.register_cmd(551, exec_Z3_fixedpoint_update_rule, "Z3_fixedpoint_update_rule");
  in.register_cmd(552, exec_Z3_fixedpoint_get_num_levels, "Z3_fixedpoint_get_num_levels");
  in.register_cmd(553, exec_Z3_fixedpoint_get_cover_delta, "Z3_fixedpoint_get_cover_delta");
  in.register_cmd(554, exec_Z3_fixedpoint_add_cover, "Z3_fixedpoint_add_cover");
  in.register_cmd(555, exec_Z3_fixedpoint_get_statistics, "Z3_fixedpoint_get_statistics");
  in.register_cmd(556, exec_Z3_fixedpoint_register_relation, "Z3_fixedpoint_register_relation");
  in.register_cmd(557, exec_Z3_fixedpoint_set_predicate_representation, "Z3_fixedpoint_set_predicate_representation");
  in.register_cmd(558, exec_Z3_fixedpoint_get_rules, "Z3_fixedpoint_get_rules");
  in.register_cmd(559, exec_Z3_fixedpoint_get_assertions, "Z3_fixedpoint_get_assertions");
  in.register_cmd(560, exec_Z3_fixedpoint_set_params, "Z3_fixedpoint_set_params");
  in.register_cmd(561, exec_Z3_fixedpoint_get_help, "Z3_fixedpoint_get_help");
  in.register_cmd(562, exec_Z3_fixedpoint_get_param_descrs, "Z3_fixedpoint_get_param_descrs");
  in.register_cmd(563, exec_Z3_fixedpoint_to_string, "Z3_fixedpoint_to_string");
  in.register_cmd(564, exec_Z3_fixedpoint_from_string, "Z3_fixedpoint_from_string");
  in.register_cmd(565, exec_Z3_fixedpoint_from_file, "Z3_fixedpoint_from_file");
  in.register_cmd(566, exec_Z3_mk_optimize, "Z3_mk_optimize");
  in.register_cmd(567, exec_Z3_optimize_inc_ref, "Z3_optimize_inc_ref");
  in.register_cmd(568, exec_Z3_optimize_dec_ref, "Z3_optimize_dec_ref");
  in.register_cmd(569, exec_Z3_optimize_assert, "Z3_optimize_assert");
  in.register_cmd(570, exec_Z3_optimize_assert_and_track, "Z3_optimize_assert_and_track");
  in.register_cmd(571, exec_Z3_optimize_assert_soft, "Z3_optimize_assert_soft");
  in.register_cmd(572, exec_Z3_optimize_maximize, "Z3_optimize_maximize");
  in.register_cmd(573, exec_Z3_optimize_minimize, "Z3_optimize_minimize");
  in.register_cmd(574, exec_Z3_optimize_push, "Z3_optimize_push");
  in.register_cmd(575, exec_Z3_optimize_pop, "Z3_optimize_pop");
  in.register_cmd(576, exec_Z3_optimize_check, "Z3_optimize_check");
  in.register_cmd(577, exec_Z3_optimize_get_reason_unknown, "Z3_optimize_get_reason_unknown");
  in.register_cmd(578, exec_Z3_optimize_get_model, "Z3_optimize_get_model");
  in.register_cmd(579, exec_Z3_optimize_get_unsat_core, "Z3_optimize_get_unsat_core");
  in.register_cmd(580, exec_Z3_optimize_set_params, "Z3_optimize_set_params");
  in.register_cmd(581, exec_Z3_optimize_get_param_descrs, "Z3_optimize_get_param_descrs");
  in.register_cmd(582, exec_Z3_optimize_get_lower, "Z3_optimize_get_lower");
  in.register_cmd(583, exec_Z3_optimize_get_upper, "Z3_optimize_get_upper");
  in.register_cmd(584, exec_Z3_optimize_get_lower_as_vector, "Z3_optimize_get_lower_as_vector");
  in.register_cmd(585, exec_Z3_optimize_get_upper_as_vector, "Z3_optimize_get_upper_as_vector");
  in.register_cmd(586, exec_Z3_optimize_to_string, "Z3_optimize_to_string");
  in.register_cmd(587, exec_Z3_optimize_from_string, "Z3_optimize_from_string");
  in.register_cmd(588, exec_Z3_optimize_from_file, "Z3_optimize_from_file");
  in.register_cmd(589, exec_Z3_optimize_get_help, "Z3_optimize_get_help");
  in.register_cmd(590, exec_Z3_optimize_get_statistics, "Z3_optimize_get_statistics");
  in.register_cmd(591, exec_Z3_optimize_get_assertions, "Z3_optimize_get_assertions");
  in.register_cmd(592, exec_Z3_optimize_get_objectives, "Z3_optimize_get_objectives");
  in.register_cmd(593, exec_Z3_mk_fpa_rounding_mode_sort, "Z3_mk_fpa_rounding_mode_sort");
  in.register_cmd(594, exec_Z3_mk_fpa_round_nearest_ties_to_even, "Z3_mk_fpa_round_nearest_ties_to_even");
  in.register_cmd(595, exec_Z3_mk_fpa_rne, "Z3_mk_fpa_rne");
  in.register_cmd(596, exec_Z3_mk_fpa_round_nearest_ties_to_away, "Z3_mk_fpa_round_nearest_ties_to_away");
  in.register_cmd(597, exec_Z3_mk_fpa_rna, "Z3_mk_fpa_rna");
  in.register_cmd(598, exec_Z3_mk_fpa_round_toward_positive, "Z3_mk_fpa_round_toward_positive");
  in.register_cmd(599, exec_Z3_mk_fpa_rtp, "Z3_mk_fpa_rtp");
  in.register_cmd(600, exec_Z3_mk_fpa_round_toward_negative, "Z3_mk_fpa_round_toward_negative");
  in.register_cmd(601, exec_Z3_mk_fpa_rtn, "Z3_mk_fpa_rtn");
  in.register_cmd(602, exec_Z3_mk_fpa_round_toward_zero, "Z3_mk_fpa_round_toward_zero");
  in.register_cmd(603, exec_Z3_mk_fpa_rtz, "Z3_mk_fpa_rtz");
  in.register_cmd(604, exec_Z3_mk_fpa_sort, "Z3_mk_fpa_sort");
  in.register_cmd(605, exec_Z3_mk_fpa_sort_half, "Z3_mk_fpa_sort_half");
  in.register_cmd(606, exec_Z3_mk_fpa_sort_16, "Z3_mk_fpa_sort_16");
  in.register_cmd(607, exec_Z3_mk_fpa_sort_single, "Z3_mk_fpa_sort_single");
  in.register_cmd(608, exec_Z3_mk_fpa_sort_32, "Z3_mk_fpa_sort_32");
  in.register_cmd(609, exec_Z3_mk_fpa_sort_double, "Z3_mk_fpa_sort_double");
  in.register_cmd(610, exec_Z3_mk_fpa_sort_64, "Z3_mk_fpa_sort_64");
  in.register_cmd(611, exec_Z3_mk_fpa_sort_quadruple, "Z3_mk_fpa_sort_quadruple");
  in.register_cmd(612, exec_Z3_mk_fpa_sort_128, "Z3_mk_fpa_sort_128");
  in.register_cmd(613, exec_Z3_mk_fpa_nan, "Z3_mk_fpa_nan");
  in.register_cmd(614, exec_Z3_mk_fpa_inf, "Z3_mk_fpa_inf");
  in.register_cmd(615, exec_Z3_mk_fpa_zero, "Z3_mk_fpa_zero");
  in.register_cmd(616, exec_Z3_mk_fpa_fp, "Z3_mk_fpa_fp");
  in.register_cmd(617, exec_Z3_mk_fpa_numeral_float, "Z3_mk_fpa_numeral_float");
  in.register_cmd(618, exec_Z3_mk_fpa_numeral_double, "Z3_mk_fpa_numeral_double");
  in.register_cmd(619, exec_Z3_mk_fpa_numeral_int, "Z3_mk_fpa_numeral_int");
  in.register_cmd(620, exec_Z3_mk_fpa_numeral_int_uint, "Z3_mk_fpa_numeral_int_uint");
  in.register_cmd(621, exec_Z3_mk_fpa_numeral_int64_uint64, "Z3_mk_fpa_numeral_int64_uint64");
  in.register_cmd(622, exec_Z3_mk_fpa_abs, "Z3_mk_fpa_abs");
  in.register_cmd(623, exec_Z3_mk_fpa_neg, "Z3_mk_fpa_neg");
  in.register_cmd(624, exec_Z3_mk_fpa_add, "Z3_mk_fpa_add");
  in.register_cmd(625, exec_Z3_mk_fpa_sub, "Z3_mk_fpa_sub");
  in.register_cmd(626, exec_Z3_mk_fpa_mul, "Z3_mk_fpa_mul");
  in.register_cmd(627, exec_Z3_mk_fpa_div, "Z3_mk_fpa_div");
  in.register_cmd(628, exec_Z3_mk_fpa_fma, "Z3_mk_fpa_fma");
  in.register_cmd(629, exec_Z3_mk_fpa_sqrt, "Z3_mk_fpa_sqrt");
  in.register_cmd(630, exec_Z3_mk_fpa_rem, "Z3_mk_fpa_rem");
  in.register_cmd(631, exec_Z3_mk_fpa_round_to_integral, "Z3_mk_fpa_round_to_integral");
  in.register_cmd(632, exec_Z3_mk_fpa_min, "Z3_mk_fpa_min");
  in.register_cmd(633, exec_Z3_mk_fpa_max, "Z3_mk_fpa_max");
  in.register_cmd(634, exec_Z3_mk_fpa_leq, "Z3_mk_fpa_leq");
  in.register_cmd(635, exec_Z3_mk_fpa_lt, "Z3_mk_fpa_lt");
  in.register_cmd(636, exec_Z3_mk_fpa_geq, "Z3_mk_fpa_geq");
  in.register_cmd(637, exec_Z3_mk_fpa_gt, "Z3_mk_fpa_gt");
  in.register_cmd(638, exec_Z3_mk_fpa_eq, "Z3_mk_fpa_eq");
  in.register_cmd(639, exec_Z3_mk_fpa_is_normal, "Z3_mk_fpa_is_normal");
  in.register_cmd(640, exec_Z3_mk_fpa_is_subnormal, "Z3_mk_fpa_is_subnormal");
  in.register_cmd(641, exec_Z3_mk_fpa_is_zero, "Z3_mk_fpa_is_zero");
  in.register_cmd(642, exec_Z3_mk_fpa_is_infinite, "Z3_mk_fpa_is_infinite");
  in.register_cmd(643, exec_Z3_mk_fpa_is_nan, "Z3_mk_fpa_is_nan");
  in.register_cmd(644, exec_Z3_mk_fpa_is_negative, "Z3_mk_fpa_is_negative");
  in.register_cmd(645, exec_Z3_mk_fpa_is_positive, "Z3_mk_fpa_is_positive");
  in.register_cmd(646, exec_Z3_mk_fpa_to_fp_bv, "Z3_mk_fpa_to_fp_bv");
  in.register_cmd(647, exec_Z3_mk_fpa_to_fp_float, "Z3_mk_fpa_to_fp_float");
  in.register_cmd(648, exec_Z3_mk_fpa_to_fp_real, "Z3_mk_fpa_to_fp_real");
  in.register_cmd(649, exec_Z3_mk_fpa_to_fp_signed, "Z3_mk_fpa_to_fp_signed");
  in.register_cmd(650, exec_Z3_mk_fpa_to_fp_unsigned, "Z3_mk_fpa_to_fp_unsigned");
  in.register_cmd(651, exec_Z3_mk_fpa_to_ubv, "Z3_mk_fpa_to_ubv");
  in.register_cmd(652, exec_Z3_mk_fpa_to_sbv, "Z3_mk_fpa_to_sbv");
  in.register_cmd(653, exec_Z3_mk_fpa_to_real, "Z3_mk_fpa_to_real");
  in.register_cmd(654, exec_Z3_fpa_get_ebits, "Z3_fpa_get_ebits");
  in.register_cmd(655, exec_Z3_fpa_get_sbits, "Z3_fpa_get_sbits");
  in.register_cmd(656, exec_Z3_fpa_is_numeral_nan, "Z3_fpa_is_numeral_nan");
  in.register_cmd(657, exec_Z3_fpa_is_numeral_inf, "Z3_fpa_is_numeral_inf");
  in.register_cmd(658, exec_Z3_fpa_is_numeral_zero, "Z3_fpa_is_numeral_zero");
  in.register_cmd(659, exec_Z3_fpa_is_numeral_normal, "Z3_fpa_is_numeral_normal");
  in.register_cmd(660, exec_Z3_fpa_is_numeral_subnormal, "Z3_fpa_is_numeral_subnormal");
  in.register_cmd(661, exec_Z3_fpa_is_numeral_positive, "Z3_fpa_is_numeral_positive");
  in.register_cmd(662, exec_Z3_fpa_is_numeral_negative, "Z3_fpa_is_numeral_negative");
  in.register_cmd(663, exec_Z3_fpa_get_numeral_sign_bv, "Z3_fpa_get_numeral_sign_bv");
  in.register_cmd(664, exec_Z3_fpa_get_numeral_significand_bv, "Z3_fpa_get_numeral_significand_bv");
  in.register_cmd(665, exec_Z3_fpa_get_numeral_sign, "Z3_fpa_get_numeral_sign");
  in.register_cmd(666, exec_Z3_fpa_get_numeral_significand_string, "Z3_fpa_get_numeral_significand_string");
  in.register_cmd(667, exec_Z3_fpa_get_numeral_significand_uint64, "Z3_fpa_get_numeral_significand_uint64");
  in.register_cmd(668, exec_Z3_fpa_get_numeral_exponent_string, "Z3_fpa_get_numeral_exponent_string");
  in.register_cmd(669, exec_Z3_fpa_get_numeral_exponent_int64, "Z3_fpa_get_numeral_exponent_int64");
  in.register_cmd(670, exec_Z3_fpa_get_numeral_exponent_bv, "Z3_fpa_get_numeral_exponent_bv");
  in.register_cmd(671, exec_Z3_mk_fpa_to_ieee_bv, "Z3_mk_fpa_to_ieee_bv");
  in.register_cmd(672, exec_Z3_mk_fpa_to_fp_int_real, "Z3_mk_fpa_to_fp_int_real");
  in.register_cmd(673, exec_Z3_fixedpoint_query_from_lvl, "Z3_fixedpoint_query_from_lvl");
  in.register_cmd(674, exec_Z3_fixedpoint_get_ground_sat_answer, "Z3_fixedpoint_get_ground_sat_answer");
  in.register_cmd(675, exec_Z3_fixedpoint_get_rules_along_trace, "Z3_fixedpoint_get_rules_along_trace");
  in.register_cmd(676, exec_Z3_fixedpoint_get_rule_names_along_trace, "Z3_fixedpoint_get_rule_names_along_trace");
  in.register_cmd(677, exec_Z3_fixedpoint_add_invariant, "Z3_fixedpoint_add_invariant");
  in.register_cmd(678, exec_Z3_fixedpoint_get_reachable, "Z3_fixedpoint_get_reachable");
  in.register_cmd(679, exec_Z3_qe_model_project, "Z3_qe_model_project");
  in.register_cmd(680, exec_Z3_qe_model_project_skolem, "Z3_qe_model_project_skolem");
  in.register_cmd(681, exec_Z3_model_extrapolate, "Z3_model_extrapolate");
  in.register_cmd(682, exec_Z3_qe_lite, "Z3_qe_lite");
}
