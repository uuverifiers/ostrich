...
(assert (= literal_6 "\u{3c}\u{2f}\u{62}\u{3e}\u{3c}\u{2f}\u{74}\u{64}\u{3e}\u{0d}\u{0a}\u{3c}\u{74}\u{64}\u{20}\u{63}\u{6c}\u{61}\u{73}\u{73}\u{3d}\u{27}\u{74}\u{62}\u{6c}\u{32}\u{27}\u{3e}"))
(assert (= x_7 (str.++ x_5 literal_6)))
(assert (= epsilon ""))
(assert (or (= x_8 epsilon) (= x_8 sigmaStar_0)))
(assert (= x_9 (str.++ x_7 x_8)))
(assert (= literal_10 "\u{3c}\u{2f}\u{74}\u{64}\u{3e}\u{0d}\u{0a}\u{3c}\u{2f}\u{74}\u{72}\u{3e}\u{0d}\u{0a}\u{3c}\u{2f}\u{74}\u{61}\u{62}\u{6c}\u{65}\u{3e}\u{5c}\u{6e}"))
