...
; This is the SAT control for fail5: the third output shift is omitted.
...
"))))
; Reject the shortest relational tuple and force an alternative witness.
(assert (= (str.len rem) 1))
(check-sat)
