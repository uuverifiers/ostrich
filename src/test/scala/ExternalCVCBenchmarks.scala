...
//                        false)
  ...
  property("31") = checkFile("external-benchmarks/cvc/31/model", "sat")
  property("32") = checkFile("external-benchmarks/cvc/32/model", "sat")
  property("36") = checkFile("external-benchmarks/cvc/36/model", "sat")
  property("38") = checkFile("external-benchmarks/cvc/38/model", "sat")
  property("39") = checkFile("external-benchmarks/cvc/39/model", "sat")
  property("40") = checkFile("external-benchmarks/cvc/40/model", "sat")
  property("44") = checkFile("external-benchmarks/cvc/44/model", "sat")
  property("46") = checkFile("external-benchmarks/cvc/46/model", "sat")
  property("47") = checkFile("external-benchmarks/cvc/47/model", "sat")
  property("48") = checkFile("external-benchmarks/cvc/48/model", "sat")
  property("52") = checkFile("external-benchmarks/cvc/52/model", "sat")
  property("54") = checkFile("external-benchmarks/cvc/54/model", "sat")
  property("55") = checkFile("external-benchmarks/cvc/55/model", "sat")
  property("56") = checkFile("external-benchmarks/cvc/56/model", "sat")
  property("60") = checkFile("external-benchmarks/cvc/60/model", "sat")
  property("62") = checkFile("external-benchmarks/cvc/62/model", "sat")
  property("63") = checkFile("external-benchmarks/cvc/63/model", "sat")
  ...
  property("2204") = checkFile("external-benchmarks/cvc/2204/model", "sat")
  property("2648") = checkFile("external-benchmarks/cvc/2648/model", "sat")
  property("2705") = checkFile("external-benchmarks/cvc/2705/model", "sat")
  property("2728") = checkFile("external-benchmarks/cvc/2728/model", "sat")
