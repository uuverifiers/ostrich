...
class LinearAbstractionSolver(val approx: Approx = Approx("no")) extends AtomConstraintsSolver {
...
class CatraBasedSolver(val approx: Approx = Approx("no"))
    extends AtomConstraintsSolver {
